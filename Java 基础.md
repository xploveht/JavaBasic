...
> java.lang.CloneNotSupportedException: Clone.CloneExample
> 	at java.lang.Object.clone(Native Method)
> 	at Clone.CloneExample.clone(CloneExample.java:9)
> 	at Clone.CloneExample.main(CloneExample.java:15)

​		以上抛出了 CloneNotSupportedException，这是因为 CloneExample 没有实现 Cloneable 接⼝。应该注意的是**，clone() ⽅法并不是 Cloneable 接⼝的⽅法，⽽是 Object 的⼀个 protected ⽅法**。 Cloneable 接⼝只是规定，如果⼀个类没有实现 Cloneable 接⼝⼜调⽤了 clone() ⽅法，抛CloneNotSupportedException。 
...
**4. clone()** 的替代⽅案 使⽤ clone() ⽅法来拷⻉⼀个对象即复杂⼜有⻛险，它会抛出异常，并且还需要类型转换。**最好不要去使⽤ clone()，可以使⽤拷⻉构造函数或者拷⻉⼯⼚来拷⻉⼀个对象。** 
